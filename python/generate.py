...
def make_small_instance() -> Instance:
    ...
    """
    cities = []
    pairs = "18 14 17 11 22 12 13 14 15 19 18 11 21 9 11 18 22 17 21 12 22 13 19 9 16 15 22 8 17 10 11 14 10 18 20 11 9 20 19 18 14 14 12 22 11 17 0 0 29 29 0 7"
